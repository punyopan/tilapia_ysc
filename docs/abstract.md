...
### ภาษาไทย (ใช้ชื่อนี้) — 164 ตัวอักษร

> แบบจำลองเชิงคำนวณการแพร่กระจายและการกลับมาระบาดซ้ำของปลาหมอคางดำ
> ร่วมกับการสกัดข้อมูลจากข้อความภาษาไทยด้วยแบบจำลองภาษาขนาดใหญ่
...
ครบทั้งสามส่วนตามแบบ YSC เหมือนเดิม เหลือระยะเผื่อ 36 ตัวอักษร

**ตัวเลือกอื่นที่อยู่ในข้อจำกัด**

| ชื่อ | ตัวอักษร | ต่างจากฉบับหลักอย่างไร |
|---|---|---|
| แบบจำลองเชิงคำนวณการกลับมาระบาดซ้ำของปลาหมอคางดำ จากข้อมูลที่สกัดจากข้อความภาษาไทยด้วยแบบจำลองภาษาขนาดใหญ่ เพื่อจำแนกพื้นที่ที่การกำจัดให้ผลถาวรในระดับตำบล | 155 | ระบุ **ระดับตำบล** ชัดเจน แต่ตัด `การแพร่กระจาย` ออก |
| แบบจำลองเชิงคำนวณการกลับมาระบาดซ้ำของปลาหมอคางดำ จากข้อมูลที่สกัดจากข้อความภาษาไทยด้วยแบบจำลองภาษาขนาดใหญ่ เพื่อจำแนกพื้นที่ที่การกำจัดให้ผลถาวร | 144 | สั้นที่สุด เผื่อระยะมากที่สุด |

> **วิธีนับอาจต่างกัน** แบบฟอร์มส่วนใหญ่นับด้วย JavaScript `.length` ซึ่งได้ 164

...
## วัตถุประสงค์ — ฉบับกรอกแบบฟอร์ม (จำกัด 500 ตัวอักษร)

**ใช้ฉบับนี้ในช่องวัตถุประสงค์ — 455 ตัวอักษร เหลือระยะเผื่อ 45**

```
๑. เพื่อสร้างชุดข้อมูลการพบปลาหมอคางดำระดับตำบล โดยสกัดจากข้อความภาษาไทยด้วยโมเดลภาษาขนาดใหญ่ และตรวจสอบความถูกต้องกับการตรวจพบระดับจังหวัดที่มีบันทึกอยู่แล้ว
๒. เพื่อประมาณค่าและเปรียบเทียบแบบจำลองเครือข่ายการแพร่กระจายสองชั้น ระหว่างการแพร่กระจายตามแหล่งน้ำกับการเคลื่อนย้ายโดยมนุษย์ ด้วยการทำนายแบบนอกกลุ่มตัวอย่าง
๓. เพื่อคำนวณแรงกดดันการรุกรานซ้ำ และจัดลำดับตำบลที่การกำจัดให้ผลถาวร พร้อมระบุระดับความอิ่มตัวของเครือข่ายที่การกำจัดถาวรไม่เป็นไปได้อีก
```

**ฉบับสำรอง หากต้องการระยะเผื่อมากกว่านี้ — 404 ตัวอักษร เหลือ 96**
ตัดคำว่า `เพื่อ` ออก ซึ่งกระชับกว่าแต่ไม่ตรงแบบแผนการเขียนวัตถุประสงค์เท่าฉบับแรก

```
๑. สร้างชุดข้อมูลการพบปลาหมอคางดำระดับตำบล โดยสกัดจากข้อความภาษาไทยด้วยโมเดลภาษาขนาดใหญ่ และตรวจสอบความถูกต้องกับการตรวจพบระดับจังหวัดที่บันทึกไว้แล้ว
๒. ประมาณค่าและเปรียบเทียบแบบจำลองเครือข่ายสองชั้น ระหว่างการแพร่กระจายตามแหล่งน้ำกับการเคลื่อนย้ายโดยมนุษย์ ด้วยการทำนายนอกกลุ่มตัวอย่าง
๓. คำนวณแรงกดดันการรุกรานซ้ำ จัดลำดับตำบลที่การกำจัดให้ผลถาวร และระบุระดับความอิ่มตัวที่การกำจัดถาวรไม่เป็นไปได้อีก
```

> **เกณฑ์วัดผลย้ายไปอยู่ในเนื้อรายงาน** ช่อง 500 ตัวอักษรใส่ได้แค่ตัววัตถุประสงค์
> เกณฑ์วัดของแต่ละข้ออยู่ในหัวข้อถัดไป และควรยกไปไว้ในส่วนวิธีดำเนินการของรายงาน
>
> **ตัวเลขนับด้วย JavaScript `.length` รวมการขึ้นบรรทัดใหม่ 2 ตัว** ถ้าแบบฟอร์ม
> นับต่างออกไป ให้ดูตัวนับของแบบฟอร์มเป็นหลัก
